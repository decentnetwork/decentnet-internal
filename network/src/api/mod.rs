...
impl DecentNetworkBehaviour {
    pub fn list_nodes(swarm: &mut Swarm<Self>, config: &NetworkConfig) -> Vec<NetworkNode> {
    ...
    pub fn get_nodes_from_bootnodes(swarm: &mut Swarm<Self>, config: &NetworkConfig) {
    ...
    pub fn external_addresses(swarm: &mut Swarm<Self>) -> impl Iterator<Item = &Multiaddr> {
